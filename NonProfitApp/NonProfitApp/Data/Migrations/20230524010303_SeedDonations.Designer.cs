...
namespace NonProfitApp.Data.Migrations
{
    ...
    [Migration("20230524010303_SeedDonations")]
            ...
            modelBuilder.Entity("NonProfitApp.Models.Donation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DonationId = 100,
                            ChannelId = 4,
                            DonationAmount = 3000.00m,
                            DonationDate = new DateTime(2023, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DonorId = 1,
                            FundraiserId = 1000,
                            ProgramId = 100
                        },
                        new
                        {
                            DonationId = 101,
                            ChannelId = 3,
                            DonationAmount = 500.50m,
                            DonationDate = new DateTime(2021, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DonorId = 2,
                            FundraiserId = 1001,
                            ProgramId = 101
                        },
                        new
                        {
                            DonationId = 102,
                            ChannelId = 1,
                            DonationAmount = 1000.00m,
                            DonationDate = new DateTime(2022, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DonorId = 1,
                            FundraiserId = 1002,
                            ProgramId = 103
                        },
                        new
                        {
                            DonationId = 103,
                            ChannelId = 2,
                            DonationAmount = 10000.88m,
                            DonationDate = new DateTime(2023, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DonorId = 4,
                            FundraiserId = 1002,
                            ProgramId = 100
                        });
            ...
            modelBuilder.Entity("NonProfitApp.Models.Fundraiser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FundraiserId = 1000,
                            EndDate = new DateTime(2023, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FundraiserName = "2023 Gala",
                        ...
                        new
                        {
                            ...
                            FundraiserName = "2021 Giving Tuesday",
                            StartDate = new DateTime(2022, 11, 24, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
